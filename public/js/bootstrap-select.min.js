  ...
  !(function (T) {
      ...
      (te.prototype = {
        ...
        createDropdown: function () {
          ...
          var n,
            ...
            c = "";
          return (
            this.options.header && (o = '<div class="' + G.POPOVERHEADER + '"><button type="button" class="close" aria-hidden="true">&times;</button>' + this.options.header + "</div>"),
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  !0 === u
                    ? ((v = 0 === N.selectpicker.view.position0 ? 0 : N.selectpicker.current.data[N.selectpicker.view.position0 - 1].position),
        ...
        setPlaceholder: function () {
          ...
          if ((this.options.placeholder || this.options.allowClear) && !this.multiple) {
            ...
            n && ((this.selectpicker.view.titleOption.className = "bs-title-option"), (this.selectpicker.view.titleOption.value = ""), (s = !l || (o === a && !1 === l.defaultSelected && void 0 === this.$element.data("selected")))),
        ...
        buildData: function (p, e) {
          ...
          function i(e, t) {
            ...
            if (o.length) {
              var l,
                r,
                a = { display: E(u(I, "label")), subtext: u(i, "subtext"), icon: u(i, "icon"), type: "optgroup-label", optgroupClass: " " + (i.className || "") };
        ...
        buildList: function (e, t) {
          ...
          e
            ? t
              ...
              : (Array.prototype.push.apply(this.selectpicker.main.elements, s), (this.selectpicker.current.elements = this.selectpicker.main.elements))
            : t
        ...
        render: function (e) {
              ...
              for (var u = 0; u < l && u < 50; u++) {
                ...
                f &&
                  ...
                  f.title
                    ...
                    : (i.options.showIcon && (m.icon = f.icon), i.options.showSubtext && !i.multiple && f.subtext && (m.subtext = " " + f.subtext), (m.text = f.text.trim())),
          ...
          if (
            (h.childNodes.length || (h = Z.text.call(this, { text: this.options.placeholder ? this.options.placeholder : this.options.noneSelectedText }, !0)),
            ...
            this.setMenuSize(),
              ...
              "auto" === this.options.size
                ? i
                    ...
                    .on("resize" + F + "." + this.selectId + ".setMenuSize scroll" + F + "." + this.selectId + ".setMenuSize", function () {
                      return t.setMenuSize();
                    })
                : this.options.size &&
                  "auto" != this.options.size &&
        ...
        setSelected: function (e, t) {
          ...
          o &&
            ...
            r || l || !t || void 0 === this.prevActiveIndex || ((i = this.selectpicker.main.elements[this.prevActiveIndex]), this.defocusItem(i)));
        },
        setDisabled: function (e) {
          ...
          s &&
            ...
            t && ("4" <= j.major && t.classList.toggle(G.DISABLED, i), i ? (t.setAttribute("aria-disabled", i), t.setAttribute("tabindex", -1)) : (t.removeAttribute("aria-disabled"), t.setAttribute("tabindex", 0))));
        },
        isDisabled: function () {
        ...
        checkDisabled: function () {
          this.isDisabled()
            ...
            : this.$button[0].classList.contains(G.DISABLED) && (this.$newElement[0].classList.remove(G.DISABLED), this.$button.removeClass(G.DISABLED).attr("aria-disabled", !1));
        },
            ...
            this.$menuInner.on("click", "li a", function (e, t) {
              ...
              if ((O.multiple && 1 !== O.options.maxOptions && e.stopPropagation(), e.preventDefault(), !O.isDisabled() && !i.parent().hasClass(G.DISABLED))) {
                  ...
                  if ((O.setSelected(o, !f), O.focusedParent.focus(), !1 !== g || !1 !== b)) {
                    ...
                    if ((g && w) || (b && I))
                      if (g && 1 == g) (s.selectedIndex = -1), (p.selected = !0), O.setOptionStatus(!0);
                        ...
                        $[2] && ((S = S.replace("{var}", $[2][1 < g ? 0 : 1])), (E = E.replace("{var}", $[2][1 < b ? 0 : 1]))),
                          (p.selected = !1),
                          O.$menu.append(C),
                ...
                O.options.source.data && O.$element[0].appendChild(O.selectpicker.main.optionQueue),
                  ...
                  h && ((!O.multiple && a === s.selectedIndex) || ((D = [p.index, u.prop("selected"), r]), O.$element.triggerNative("change")));
              }
            }),
            ...
            this.$button
              ...
              .on("blur" + F, function (e) {
                void 0 !== O.selectpicker.view.tabindex &&
                  ...
                  (O.$element[0].setAttribute("tabindex", O.selectpicker.view.tabindex), this.setAttribute("tabindex", -1), (O.selectpicker.view.tabindex = void 0));
              }),
            this.$element
        ...
        keydown: function (e) {
          ...
          if (!(112 <= e.which && e.which <= 123))
            if (!(i = a.$menu.hasClass(G.SHOW)) && (p || (48 <= e.which && e.which <= 57) || (96 <= e.which && e.which <= 105) || (65 <= e.which && e.which <= 90)) && (a.$button.trigger("click.bs.dropdown.data-api"), a.options.liveSearch))
              ...
              i &&
                ((e.which === W && !a.selectpicker.keydown.keyHistory) || e.which === H || (e.which === B && a.options.selectOnTab)) &&
                (e.which !== W && e.preventDefault(),
                (a.options.liveSearch && e.which === W) || (a.$menuInner.find(".active a").trigger("click", !0), l.trigger("focus"), a.options.liveSearch || (e.preventDefault(), T(document).data("spaceSelect", !0))));
            }
        },
        mobile: function () {
    ...
    (T.fn.selectpicker = ie),
      ...
      T(document)
        ...
        .on("keydown" + F, ".bootstrap-select [" + q.DATA_TOGGLE + '], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', te.prototype.keydown)
        .on("focusin.modal", ".bootstrap-select [" + q.DATA_TOGGLE + '], .bootstrap-select [role="listbox"], .bootstrap-select .bs-searchbox input', function (e) {
          e.stopPropagation();
        }),
